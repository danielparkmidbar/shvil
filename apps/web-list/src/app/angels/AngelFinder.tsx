...
function serviceTags(
  ...
  if (b && ((b.room ?? 0) > 0 || (b.sofa ?? 0) > 0 || (b.tent ?? 0) > 0)) {
    ...
    if ((b.room ?? 0) > 0) tags.push({ key: 'bedRoom', label: a.bedRoomCount(b.room!) });
    if ((b.sofa ?? 0) > 0) tags.push({ key: 'bedSofa', label: a.bedSofaCount(b.sofa!) });
    if ((b.tent ?? 0) > 0) tags.push({ key: 'bedTent', label: a.bedTentCount(b.tent!) });
  } else {
